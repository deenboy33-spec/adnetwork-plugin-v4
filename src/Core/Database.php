...
class Database {
    ...
    private function createCoreTables(string $charset): void {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$table} (
            ...
            balance_cp decimal(15,2) NOT NULL DEFAULT 0.00,
            balance_gsc decimal(15,8) NOT NULL DEFAULT 0.00000000,
            balance_bp decimal(15,0) NOT NULL DEFAULT 0,
            balance_sh decimal(15,2) NOT NULL DEFAULT 0.00,
